...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-SY2CP56I.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-SY2CP56I.js")).default(client, args);
    case "add":
      return (await import("./add-JALB3DKU.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-AYUGCLVJ.js")).default(client, args);
    case "rm":
      return (await import("./rm-3EGKFLKW.js")).default(client, args);
    case "update":
      return (await import("./update-6EM4XIDW.js")).default(client, args);
    default:
